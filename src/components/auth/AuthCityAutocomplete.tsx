...
interface AuthCityAutocompleteProps {
...
export function AuthCityAutocomplete({
  form,
  fieldName,
  disabled = false,
  onCitySelect,
}: AuthCityAutocompleteProps) {
  ...
  const handleSelect = (cityName: string) => {
    form.setValue(fieldName, cityName, { shouldValidate: true });
    setOpen(false);
    setSearchQuery("");
              ...
              <FormControl>
                <div className="relative">
                  <Input
                    ...
                    dir="rtl"
                  />
                  <MapPin className="absolute end-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                </div>
              </FormControl>
            </PopoverTrigger>
